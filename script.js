...
var criminalMinds ={
    ...
    pictureLink: "criminalMinds.jpg",
    quote: "There are monsters and its okay to be afraid of them. But it's not ok to let them win and it's not ok to be one."
}
var strangerThings ={
    title:"Stranger Things",
    pictureLink: "strangerThings.jpg",
    quote: "You shouldn't like things just because people tell you you're supposed to."
}
...
function displayQuestion(id) {
    if (id == "circle1") {
        ...
        img4.setAttribute("id", "criminalMinds")
        assets.appendChild(img4)
        
        //create image5
        //set attributes
        //append to assets
        var img5 = document.createElement("img")
        img5.setAttribute("id", "strangerThings")
        assets.appendChild(img5)
        ...
        show = gilmoreGirls
        ent.setAttribute("position", "2 0 -2")
        ent.setAttribute("rotation", "365 -30 0")
        ent.setAttribute("visible", "true")
        ...
        b3.setAttribute("id", "gilmore")
        b3.setAttribute("onclick", "isCorrect('gilmore')")
        ...
        show = greysAnatomy
        console.log(show)
        ent.setAttribute("position", "-2 3 -5")
        ...
        var b2text = document.getElementById("b2text")
        var b3 = document.getElementById("correct2")
        var b3text = document.getElementById("b3text")
        var b4 = document.getElementById("b4")
        var b4text = document.getElementById("b4text")
        ent.setAttribute("visible", "true")
        ...
        show = criminalMinds
        console.log(show)
        ent.setAttribute("position", "3 0 0")
        ent.setAttribute("rotation", "360 -55 0")
        ent.setAttribute("visible", "true")
        ...
        var img4 = document.getElementById("criminalMinds")
        img4.setAttribute("src", show.pictureLink)
        var imagePlane = document.getElementById("imagePlane")
        var title = document.getElementById("title")

        var b1 = document.getElementById("correct3")
        var b1text = document.getElementById("b1text")
        var b2 = document.getElementById("correct")
        ...
        imagePlane.setAttribute("src", "#criminalMinds")
        console.log(imagePlane)
        imagePlane.setAttribute("width", "5")
        imagePlane.setAttribute("height", "3")
        imagePlane.setAttribute("position", "0 3 -4.8")

        b1text.setAttribute("value", "Quantico")
        b2text.setAttribute("value", "NCIS")
        b3text.setAttribute("value", "Bones")
        b4text.setAttribute("value", "Criminal Minds")
        b4.setAttribute("id", "correct4")
        b4.setAttribute("onclick", "isCorrect('correct4')")
        circle4.setAttribute("visible", "false")
    }
    ...
    //     circle5.setAttribute("visible", "false")

    //     var plane = document.getElementById("plane")

    //     var img5 = document.getElementById("strangerThings")
    //     img5.setAttribute("src", show.pictureLink)
    //     var imagePlane = document.getElementById("imagePlane")
    //     var title = document.getElementById("title")
    ...
    //     var b2text = document.getElementById("b2text")
    //     var b3 = document.getElementById("correct")
    //     var b3text = document.getElementById("b3text")
    //     var b4 = document.getElementById("correct4")
    //     var b4text = document.getElementById("b4text")
    //     //var circle5 = document.getElementById("circle5")
    //     ent.setAttribute("visible", "true")

    //     //fix this image plane shit 
    //     imagePlane.setAttribute("src", "#strangerThings")
    //     console.log(imagePlane)
    //     imagePlane.setAttribute("width", "5")
    //     imagePlane.setAttribute("height", "3")
    //     imagePlane.setAttribute("position", "0 3 -4.8")

    //     b1text.setAttribute("value", "Hemlock Grove")
    //     b2text.setAttribute("value", "Sense8")
    //     b3text.setAttribute("value", "Stranger Things")
    //     b3.setAttribute("id", "correct5")
    //     b3.setAttribute("onclick", "isCorrect('correct5')")
    //     //circle5.setAttribute("visible", "false")
    //     b4text.setAttribute("value", "Outcast")
...
function isCorrect(idval) {
    if (idval == "correct") {
        ...
        ent.setAttribute("visible", "false")
        document.getElementById("circle4").setAttribute("visible", "true")
    }
    else if (idval == "correct4") {
        console.log(document.getElementById("circle4"))
        ent.setAttribute("visible", "false")
        document.getElementById("circle5").setAttribute("visible", "true")
   /* else if (idval == "correct5") {
        console.log(document.getElementById("circle5"))
        ent.setAttribute("visible", "false")*/
        document.getElementById("circle5").setAttribute("visible", "true")
        ...
        var circle5 = document.getElementById("circle5")
        circle5.setAttribute("visible", "true")
        circle5.setAttribute("onclick", "youWon('circle5')")
    }
}
function youWon(id) {
    if (id == "circle5") {
